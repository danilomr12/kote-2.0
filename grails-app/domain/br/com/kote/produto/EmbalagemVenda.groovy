...
class EmbalagemVenda {
   ...
   // @SearchableProperty
    ...
    static EmbalagemVenda setEmbalagem(String embalagem) {
        ...
        int indicePrimeiraBarraNaString = getIndicePrimeiraBarra(embalagem)
        int indiceSegundaBarraNaString = getIndiceSegundaBarraNaString(indicePrimeiraBarraNaString, embalagem)
